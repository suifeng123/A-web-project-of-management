<template>
  ...
  <div class="maindiv">
    ...
    <novalidator name="validation">
    <form novalidate>
      <label for="haha">输入</label>
     <input id="haha" type="text" v-validator:comment="{minlength:6,maxlength:10}"/>
      <div>
        <span v-show="$validation.comment.minlength">你的输入太短了</span>
      </div>
